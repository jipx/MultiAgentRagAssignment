...
bedrock_runtime = boto3.client("bedrock-agent-runtime", region_name=os.environ.get("AWS_REGION", "ap-norththeast-1"))
        ...
        response = bedrock_runtime.retrieve_and_generate(
            ...
            "retrieveAndGenerateConfiguration": {
                ...
                "knowledgeBaseConfiguration": {
                    ...
                    "modelArn": "arn:aws:bedrock:ap-northeast-1::foundation-model/amazon.titan-text-lite-v1"
