...
def run_codereview_agent(question: str) -> str:
    ...
    # Updated prompt now includes request for hardened version of the code
...
2. A list of identified security vulnerabilities or design concerns.
3. Specific recommendations for improving the security of the code.
4. ✅ A rewritten **hardened version of the code** that addresses the vulnerabilities, using secure coding best practices.
"""
